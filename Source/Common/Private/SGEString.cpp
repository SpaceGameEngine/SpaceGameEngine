...
const SpaceGameEngine::TChar* SpaceGameEngine::String::ToCString() const { return m_pImplement->ToCString(); }

SpaceGameEngine::TChar* SpaceGameEngine::String::GetData() { return m_pImplement->GetData(); }

SpaceGameEngine::SizeType SpaceGameEngine::String::GetSize() { return m_pImplement->GetSize(); }
