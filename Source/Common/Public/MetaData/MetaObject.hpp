	...
	*/
	...
	public:
		struct ImproperMetaDataError
		{
			...
			{
				return !(
					meta_data.m_pName != nullptr &&
					InvalidSizeError::Judge(meta_data.m_Size, 1, SGE_MAX_MEMORY_SIZE) == false &&
					((meta_data.m_Alignment & (meta_data.m_Alignment - 1)) == 0 && meta_data.m_Alignment != 0) &&
					meta_data.m_pDestructor != nullptr);
			}
		};
	...
	public:
		...
		*/
		...
		inline const MetaData& GetMetaData() const { return *m_pMetaData; }
		inline void* GetData() { return m_pContent; }
		inline const void* GetData() const { return m_pContent; }
