...
namespace SpaceGameEngine
{
	...
	{
		inline static const ErrorMessageChar pContent[] = SGE_ESTR("Module's name is empty.");
		static COMMON_API bool Judge(const String& name);
	};

	struct ConflictingModuleNameError
	{
		inline static const ErrorMessageChar pContent[] = SGE_ESTR("Module's name is conflicting.");
