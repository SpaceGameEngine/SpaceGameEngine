...
TEST(List, AnotherAllocatorCopyConstructionTest)
{
	const int test_size = 1000;
	int val_pool[test_size];
	memset(val_pool, 0, sizeof(val_pool));
	...
	List<test_list_object, StdAllocator>* pl = new List<test_list_object, StdAllocator>();
	...
	ASSERT_TRUE(CheckListConnection(*pl));
	//----------------------------------------------------------
	List<test_list_object, MemoryManagerAllocator>* pl2 = new List<test_list_object, MemoryManagerAllocator>(*pl);
	ASSERT_EQ(pl2->GetSize(), test_size);
	cnt = 0;
	for (auto i = pl2->GetConstBegin(); i != pl2->GetConstEnd(); ++i, ++cnt)
	{
...
TEST(List, AnotherAllocatorMoveConstructionTest)
{
	const int test_size = 1000;
	int val_pool[test_size];
	memset(val_pool, 0, sizeof(val_pool));
	...
	ASSERT_TRUE(CheckListConnection(*pl));
	//----------------------------------------------------------
	List<test_list_object, MemoryManagerAllocator>* pl2 = new List<test_list_object, MemoryManagerAllocator>(std::move(*pl));
	ASSERT_EQ(pl2->GetSize(), test_size);
	cnt = 0;
	for (auto i = pl2->GetConstBegin(); i != pl2->GetConstEnd(); ++i, ++cnt)
	{
...
TEST(List, AnotherAllocatorCopyAssignmentTest)
{
	const int test_size = 1000;
	int val_pool[test_size];
	memset(val_pool, 0, sizeof(val_pool));
	...
	ASSERT_TRUE(CheckListConnection(*pl));
	//----------------------------------------------------------
	List<test_list_object, MemoryManagerAllocator>* pl2 = new List<test_list_object, MemoryManagerAllocator>();
	ASSERT_EQ(pl2->GetSize(), 0);
	ASSERT_EQ(pl2->GetBegin(), pl2->GetEnd());
	...
	*pl2 = *pl;
	...
	ASSERT_TRUE(CheckListConnection(*pl));
	//----------------------------------------------------------
	List<test_list_object, StdAllocator>* pl3 = new List<test_list_object, StdAllocator>();
	ASSERT_EQ(pl3->GetSize(), 0);
	ASSERT_EQ(pl3->GetBegin(), pl3->GetEnd());
...
TEST(List, AnotherAllocatorMoveAssignmentTest)
{
	const int test_size = 1000;
	int val_pool[test_size];
	memset(val_pool, 0, sizeof(val_pool));
...
TEST(ListIterator, CopyTest)
{
	...
	//----------------------------------------------
	auto iter1 = pl->GetBegin() + 1;
	ASSERT_EQ(iter1->val, 1);
	List<test_list_object>::Iterator iter2(iter1);
	ASSERT_EQ(iter1, iter2);
	ASSERT_EQ(iter2->val, 1);
	iter2 = pl->GetBegin() + 2;
	ASSERT_EQ(iter2->val, 2);
	List<test_list_object>::ConstReverseIterator iter3(iter1);
	ASSERT_EQ(iter3->val, 1);
	iter3 = iter2;
	ASSERT_EQ(iter3->val, 2);
	//----------------------------------------------
...
TEST(ListIterator, PlusAndSubtractTest)
{
	const int test_size = 1000;
	int val_pool[test_size];
	memset(val_pool, 0, sizeof(val_pool));
	...
	ASSERT_EQ(iter2->val, 2);
	iter1 += 1;
	ASSERT_EQ(iter1->val, 2);
	ASSERT_EQ(iter1, iter2);
	ASSERT_EQ((++iter1)->val, 3);
	ASSERT_EQ(iter1->val, 3);
	ASSERT_EQ((iter1++)->val, 3);
	ASSERT_EQ(iter1->val, 4);

	auto iter3 = iter1 - 1;
	ASSERT_TRUE((std::is_same_v<decltype(iter3), List<test_list_object>::Iterator>));
	ASSERT_EQ(iter3->val, 3);
	iter1 -= 1;
	ASSERT_EQ(iter1->val, 3);
	...
	auto iter4 = pl->GetReverseBegin();
	ASSERT_EQ(iter4->val, test_size - 1);
	auto iter5 = iter4 + 1;
	ASSERT_TRUE((std::is_same_v<decltype(iter5), List<test_list_object>::ReverseIterator>));
	ASSERT_EQ(iter5->val, test_size - 2);
	iter4 += 1;
	ASSERT_EQ(iter4->val, test_size - 2);
	ASSERT_EQ(iter4, iter5);
	ASSERT_EQ((++iter4)->val, test_size - 3);
	ASSERT_EQ(iter4->val, test_size - 3);
	ASSERT_EQ((iter4++)->val, test_size - 3);
	ASSERT_EQ(iter4->val, test_size - 4);

	auto iter6 = iter4 - 1;
	ASSERT_TRUE((std::is_same_v<decltype(iter6), List<test_list_object>::ReverseIterator>));
	ASSERT_EQ(iter6->val, test_size - 3);
	iter4 -= 1;
	ASSERT_EQ(iter4->val, test_size - 3);
