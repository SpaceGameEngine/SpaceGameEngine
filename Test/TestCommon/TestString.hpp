...
inline bool IsUTF8CharSame(const Char8* p1, const Char8* p2)
{
	auto size1 = StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(p1);
	auto size2 = StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(p2);
	if (size1 != size2)
		return false;
	else
		return memcmp(p1, p2, sizeof(Char8) * size1) == 0;
}
...
TEST(Storage, InstanceTest)
{
	...
	ASSERT_EQ(StringImplement::GetStringCategoryByRealSize<Char>(s3.GetRealSize()), StringImplement::StringCategory::Large);
...
TEST(Storage, CopyConstructionTest)
{
	...
	ASSERT_EQ(StringImplement::GetStringCategoryByRealSize<Char>(cs3.GetRealSize()), StringImplement::StringCategory::Large);
	...
	ASSERT_EQ(StringImplement::GetStringCategoryByRealSize<Char>(rs3.GetRealSize()), StringImplement::StringCategory::Large);
	...
	ASSERT_EQ((StringImplement::GetStringCategoryByRealSize<Char>(acs3.GetRealSize())), (StringImplement::StringCategory::Large));
	...
	ASSERT_EQ((StringImplement::GetStringCategoryByRealSize<Char>(ars3.GetRealSize())), (StringImplement::StringCategory::Large));
...
TEST(Storage, CopyAssignmentTest)
{
	...
	ASSERT_EQ(StringImplement::GetStringCategoryByRealSize<Char>(sm_s.GetRealSize()), StringImplement::StringCategory::Large);
	...
	ASSERT_EQ(StringImplement::GetStringCategoryByRealSize<Char>(ms_s.GetRealSize()), StringImplement::StringCategory::Large);
	ms_s = s2;
	...
	ASSERT_EQ(StringImplement::GetStringCategoryByRealSize<Char>(mm_s.GetRealSize()), StringImplement::StringCategory::Large);
	mm_s = s3;
...
TEST(Storage, MoveAssignmentForAnotherAllocatorTest)
{
	...
	ASSERT_EQ((StringImplement::GetStringCategoryByRealSize<Char>(s3_2.GetRealSize())), (StringImplement::StringCategory::Large));
	...
	ASSERT_EQ((StringImplement::GetStringCategoryByRealSize<Char>(s3_3.GetRealSize())), (StringImplement::StringCategory::Large));
...
TEST(StringImplement, GetNextMultipleByteCharTest)
{
	...
	*/
	const Char8* pcstr = u8"这是12345abcde";
	auto p = pcstr;
	std::size_t i = 0;
	while (*p != '\0')
	{
		i += 1;
		p = StringImplement::GetNextMultipleByteChar<Char8, UTF8Trait>(p);
	}
	ASSERT_EQ(i, 12);
}
...
{
	const Char8* pcstr = u8"\0这是12345abcde";
	auto p = pcstr + 16;
	std::size_t i = 0;
	while (*p != '\0')
	{
		i += 1;
		p = StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(p);
	}
	ASSERT_EQ(i, 12);
}
...
{
	ASSERT_EQ((StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(u8"这")), 3);
	ASSERT_EQ((StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(u8"是")), 3);
	ASSERT_EQ((StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(u8"a")), 1);
	ASSERT_EQ((StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(u8"1")), 1);
}
...
{
	ASSERT_EQ((StringImplement::CompareMultipleByteChar<Char8, UTF8Trait>(u8"a", u8"b")), -1);
	ASSERT_EQ((StringImplement::CompareMultipleByteChar<Char8, UTF8Trait>(u8"a", u8"这")), -1);
	ASSERT_EQ((StringImplement::CompareMultipleByteChar<Char8, UTF8Trait>(u8"这", u8"a")), 1);
	ASSERT_EQ((StringImplement::CompareMultipleByteChar<Char8, UTF8Trait>(u8"这", u8"这")), 0);
	ASSERT_EQ((StringImplement::CompareMultipleByteChar<Char8, UTF8Trait>(u8"a", u8"a")), 0);
}
...
TEST(BoyerMooreSearchImplement, MakeBadCharTableTest)
{
	...
	StringImplement::BoyerMooreSearchImplement::MakeBadCharTable<Char8, UTF8Trait>(v2_1.GetData(), s2_1.GetData(), s2_1.GetNormalSize());
	const Char8* pcstr2_1 = SGE_U8STR("测一");
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[0]], 9);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[1]], 8);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[2]], 7);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[3]], 12);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[4]], 11);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[5]], 10);
	ASSERT_EQ(v2_1[(UInt8)'a'], 2);
	ASSERT_EQ(v2_1[(UInt8)'b'], 1);
	ASSERT_EQ(v2_1[(UInt8)'1'], 4);
	ASSERT_EQ(v2_1[(UInt8)'2'], 3);
}
...
TEST(BoyerMooreSearchImplement, BoyerMooreSearchTest)
{
	...
	MakeBadCharTable<Char8, UTF8Trait>(v2_bct.GetData(), s2_p.GetData(), s2_p.GetNormalSize());
	...
	MakeBadCharTable<Char8, UTF8Trait>(v3_bct.GetData(), s3_p.GetData(), s3_p.GetNormalSize());
	...
	MakeBadCharTable<Char8, UTF8Trait>(v5_bct.GetData(), s5_p.GetData(), s5_p.GetNormalSize());
...
TEST(ReverseBoyerMooreSearchImplement, MakeBadCharTableTest)
{
	...
	ASSERT_EQ(s2_1.GetSize(), 10);
	ASSERT_EQ(s2_1.GetNormalSize(), 16);
	StringImplement::ReverseBoyerMooreSearchImplement::MakeBadCharTable<Char8, UTF8Trait>(v2_1.GetData(), s2_1.GetData(), s2_1.GetNormalSize());
	const Char8* pcstr2_1 = SGE_U8STR("测一");
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[0]], 6);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[1]], 1);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[2]], 2);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[3]], 3);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[4]], 4);
	ASSERT_EQ(v2_1[(UInt8)pcstr2_1[5]], 5);
	ASSERT_EQ(v2_1[(UInt8)'a'], 13);
	ASSERT_EQ(v2_1[(UInt8)'b'], 14);
	ASSERT_EQ(v2_1[(UInt8)'1'], 9);
	ASSERT_EQ(v2_1[(UInt8)'2'], 10);
}
...
{
	const Char8* pcstr = u8"这是12345abcde";
	ASSERT_EQ((StringCore<Char8, UTF8Trait>::GetCStringSize(pcstr)), 12);
}

TEST(StringCore, GetCStringNormalSize)
{
	const Char8* pcstr = u8"这是12345abcde";
	ASSERT_EQ((StringCore<Char8, UTF8Trait>::GetCStringNormalSize(pcstr)), 16);
}
...
TEST(StringCore, InstanceTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> s4(u8"这是12345abcde");
	ASSERT_EQ(s4.GetSize(), 12);
	ASSERT_EQ(memcmp(s4.GetData(), u8"这是12345abcde", s4.GetSize() * sizeof(Char8)), 0);
}
...
TEST(StringCore, GetNormalSizeTest)
{
	...
	StringCore<Char8, UTF8Trait> s2(u8"这是");
	ASSERT_EQ(s2, u8"这是");
...
TEST(StringCore, SelfPlusTest)
{
	...
	const Char8* pc_long_str_2 = u8"一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890一二三四五六七八九十1234567890";
	StringCore<Char8, UTF8Trait, StdAllocator> s2_4(pc_long_str_2);
...
TEST(StringCore, CompareLessTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> s2_4(u8"严格");
...
TEST(StringCore, CompareLessEqualTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> s2_3(u8"abc");
	ASSERT_TRUE(s2_2 <= s2_1);
	ASSERT_TRUE(s2_1 <= s2_3);
	ASSERT_TRUE(s2_3 <= s2_1);
...
TEST(StringCore, InsertTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> s2_4(SGE_U8STR("Это тест"));
...
TEST(StringCore, InsertReverseTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> s2_5(SGE_U8STR("Это тест"));
...
TEST(StringCore, OperatorAtTest)
{
	...
	memcpy(s2_1[1], SGE_U8STR("亦"), sizeof(Char8) * 3);
...
TEST(StringCore, FindTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> p2_2(SGE_U8STR("一个测试"));
...
TEST(StringCore, ConstFindTest)
{
	...
	const StringCore<Char8, UTF8Trait, StdAllocator> p2_2(SGE_U8STR("一个测试"));
...
TEST(StringCoreIterator, GetBeginTest)
{
	...
	ASSERT_EQ(memcmp(*iter2, u8"这", sizeof(Char8) * StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(u8"这")), 0);
}
...
TEST(StringCoreIterator, GetEndTest)
{
	...
	ASSERT_EQ(memcmp(*iter2, u8"\0", sizeof(Char8) * StringImplement::GetMultipleByteCharSize<Char8, UTF8Trait>(u8"\0")), 0);
}
...
TEST(StringCoreIterator, OutOfRangeTest)
{
	...
	ASSERT_FALSE(UTF8String::ConstReverseIterator::OutOfRangeError::Judge(s2.GetConstReverseBegin(), StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData()), StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData() + s2.GetNormalSize())));
	ASSERT_FALSE(UTF8String::ConstReverseIterator::OutOfRangeError::Judge(s2.GetConstReverseEnd(), StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData()), StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData() + s2.GetNormalSize())));
	ASSERT_TRUE(UTF8String::ConstReverseIterator::OutOfRangeError::Judge(s2.GetConstReverseEnd() + 1, StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData()), StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData() + s2.GetNormalSize())));
	ASSERT_TRUE(UTF8String::ConstReverseIterator::OutOfRangeError::Judge(s2.GetConstReverseBegin() - 1, StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData()), StringImplement::GetPreviousMultipleByteChar<Char8, UTF8Trait>(s2.GetData() + s2.GetNormalSize())));
}
...
TEST(StringConvert, UTF8StringToUCS2StringTest)
{
	...
	StringCore<Char8, UTF8Trait, StdAllocator> s1_2(SGE_U8STR("这是个测试test123"));
...
TEST(StringConvert, UCS2StringToUTF8StringTest)
{
	...
	ASSERT_TRUE((std::is_same_v<decltype(s1_2r), StringCore<Char8, UTF8Trait, StdAllocator>>));
	ASSERT_EQ(s1_2r.GetSize(), 12);
	...
	ASSERT_TRUE((std::is_same_v<decltype(s2_2r), StringCore<Char8, UTF8Trait, StdAllocator>>));
	ASSERT_EQ(s2_2r.GetSize(), 6);
...
#else
	ASSERT_TRUE((std::is_same_v<decltype(s2), StringCore<Char8, UTF8Trait, StdAllocator>>));
#endif
}
...
TEST(TString, ConvertTest)
{
...
#else
	ASSERT_TRUE((std::is_same_v<decltype(s2_1), StringCore<Char8, UTF8Trait, StdAllocator>>));
#endif
	...
	ASSERT_TRUE((std::is_same_v<decltype(s2_3), StringCore<Char8, UTF8Trait, StdAllocator>>));
...
{
	ASSERT_EQ(ToString<UCS2String>(0u), SGE_WSTR("0"));
...
{
	ASSERT_FALSE((IsSignedNumericalString(UCS2String(SGE_WSTR("")))));
	ASSERT_FALSE((IsSignedNumericalString(UCS2String(SGE_WSTR("abc")))));
	ASSERT_FALSE((IsSignedNumericalString(UCS2String(SGE_WSTR("-")))));
	ASSERT_FALSE((IsSignedNumericalString(UCS2String(SGE_WSTR("-a")))));
	ASSERT_FALSE((IsSignedNumericalString(UCS2String(SGE_WSTR(".")))));
	ASSERT_FALSE((IsSignedNumericalString(UCS2String(SGE_WSTR("   ")))));
	ASSERT_TRUE((IsSignedNumericalString(UCS2String(SGE_WSTR("0")))));
	ASSERT_TRUE((IsSignedNumericalString(UCS2String(SGE_WSTR("1")))));
	ASSERT_TRUE((IsSignedNumericalString(UCS2String(SGE_WSTR("12")))));
	...
	ASSERT_FALSE((IsSignedNumericalString(UTF8String(SGE_U8STR("-")))));
	ASSERT_FALSE((IsSignedNumericalString(UTF8String(SGE_U8STR("-a")))));
	ASSERT_FALSE((IsSignedNumericalString(UTF8String(SGE_U8STR(".")))));
	ASSERT_FALSE((IsSignedNumericalString(UTF8String(SGE_U8STR("   ")))));
	ASSERT_TRUE((IsSignedNumericalString(UTF8String(SGE_U8STR("0")))));
	ASSERT_TRUE((IsSignedNumericalString(UTF8String(SGE_U8STR("1")))));
	ASSERT_TRUE((IsSignedNumericalString(UTF8String(SGE_U8STR("12")))));
...
{
	ASSERT_FALSE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("abc")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("-")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("-a")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UCS2String(SGE_WSTR(".")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("   ")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("0")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("1")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("12")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UCS2String(SGE_WSTR("12345")))));
	...
	ASSERT_FALSE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("-")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("-a")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UTF8String(SGE_U8STR(".")))));
	ASSERT_FALSE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("   ")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("0")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("1")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("12")))));
	ASSERT_TRUE((IsUnsignedNumericalString(UTF8String(SGE_U8STR("12345")))));
...
{
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("abc")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("-")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("-a")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR(".")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("    ")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("1.")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("1.2.3")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("1.2..3")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("-.")))));
	ASSERT_FALSE((IsDecimalString(UCS2String(SGE_WSTR("-.0")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("0")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("0.0")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("0.000")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("000.000")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("1.0")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("123.0")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("123.1")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("123.123")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("-1.0")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("-1.1")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("-1.123")))));
	ASSERT_TRUE((IsDecimalString(UCS2String(SGE_WSTR("-123.123")))));

	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("abc")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("-")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("-a")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR(".")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("    ")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("1.")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("1.2.3")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("1.2..3")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("-.")))));
	ASSERT_FALSE((IsDecimalString(UTF8String(SGE_U8STR("-.0")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("0")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("0.0")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("0.000")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("000.000")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("1.0")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("123.0")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("123.1")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("123.123")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("-1.0")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("-1.1")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("-1.123")))));
	ASSERT_TRUE((IsDecimalString(UTF8String(SGE_U8STR("-123.123")))));
}
...
TEST(StringTo, IntTest)
{
	...
	ASSERT_EQ((StringTo<UTF8String, Int64>(SGE_U8STR("12"))), 12);
	ASSERT_EQ((StringTo<UTF8String, Int64>(SGE_U8STR("123"))), 123);
	ASSERT_EQ((StringTo<UTF8String, Int64>(SGE_U8STR("1234"))), 1234);
	ASSERT_EQ((StringTo<UTF8String, Int64>(SGE_U8STR("12345"))), 12345);
	ASSERT_EQ((StringTo<UTF8String, Int64>(SGE_U8STR("123456"))), 123456);
	ASSERT_EQ((StringTo<UTF8String, Int64>(SGE_U8STR("1234567"))), 1234567);
	...
	ASSERT_EQ((StringTo<UTF8String, UInt64>(SGE_U8STR("123"))), 123);
	ASSERT_EQ((StringTo<UTF8String, UInt64>(SGE_U8STR("1234"))), 1234);
	ASSERT_EQ((StringTo<UTF8String, UInt64>(SGE_U8STR("12345"))), 12345);
	ASSERT_EQ((StringTo<UTF8String, UInt64>(SGE_U8STR("123456"))), 123456);
	ASSERT_EQ((StringTo<UTF8String, UInt64>(SGE_U8STR("1234567"))), 1234567);
...
TEST(StringTo, FloatTest)
{
	...
	ASSERT_EQ((StringTo<UTF8String, float>(SGE_U8STR("0.1"))), 0.1f);
	ASSERT_EQ((StringTo<UTF8String, float>(SGE_U8STR("1.1"))), 1.1f);
	ASSERT_EQ((StringTo<UTF8String, float>(SGE_U8STR("123.456"))), 123.456f);
	ASSERT_EQ((StringTo<UTF8String, float>(SGE_U8STR("123456"))), 123456.0f);
	ASSERT_EQ((StringTo<UTF8String, float>(SGE_U8STR("-123.456"))), -123.456f);
}
...
TEST(StringTo, DoubleTest)
{
	...
	ASSERT_EQ((StringTo<UTF8String, double>(SGE_U8STR("0.1"))), 0.1);
	ASSERT_EQ((StringTo<UTF8String, double>(SGE_U8STR("1.1"))), 1.1);
