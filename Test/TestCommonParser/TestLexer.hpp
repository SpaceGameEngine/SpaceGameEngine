...
TEST(StateMachine, Test)
{
	...
	ASSERT_EQ(res6[0].GetType(), Lexer::TokenTypes::CommentLine);
	...
	ASSERT_EQ(res9[0].GetType(), Lexer::TokenTypes::CharacterLiteral);
	ASSERT_EQ(res9[0].GetContent(), SGE_STR("a"));
	ASSERT_EQ(res9[0].GetLine(), 1);
	ASSERT_EQ(res9[0].GetColumn(), 1);
	ASSERT_EQ(res9[1].GetType(), Lexer::TokenTypes::CharacterLiteral);
	...
	ASSERT_EQ(res10[0].GetType(), Lexer::TokenTypes::StringLiteral);
	ASSERT_EQ(res10[0].GetContent(), SGE_STR("test string\ttest"));
	ASSERT_EQ(res10[0].GetLine(), 1);
	ASSERT_EQ(res10[0].GetColumn(), 1);
	ASSERT_EQ(res10[1].GetType(), Lexer::TokenTypes::Identifier);
